...
public class CardSelectable : MonoBehaviour, ISelectable
{
    ...
    public IEnumerator PickCardUp()
    {
        ...
        yield return new WaitUntil(() => toHoldMovementTrigger.GetComponent<IMovementTrigger>().isFinished);
    ...
    public IEnumerator PlayCardOnBoard(ICell cell)
    {
        // Validation Check
        if (cell == null) { Debug.Log("Cell is null"); yield break; }
        if (board.GetCardAtCell(cell) != null) { yield break; }
        ...
        yield return new WaitUntil(() => toBoardMovementTrigger.GetComponent<IMovementTrigger>().isFinished);
    ...
    /// </summary>
    public IEnumerator PutCardBack()
    {
        ...
        yield return new WaitUntil(() => backMovementTrigger.GetComponent<IMovementTrigger>().isFinished);
